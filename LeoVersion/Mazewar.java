...
public class Mazewar extends JFrame {
        ...
        public Mazewar(String NS) {
				...
				try{
					...
					try{
						System.out.println("CLIENT waiting for naming server to respond");
						while (( packetFromServer = (NamingServerPacket) in.readObject()) != null) {
							if(packetFromServer.type==NamingServerPacket.CLIENT_REGISTER){
								host = packetFromServer.hostname.split("#")[0];
								port = packetFromServer.portNum;
								break;
							}
